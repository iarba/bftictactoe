...
There are 2 players, X and O. X starts moving first, then the players start alternating. In order to make a move, insert a number between 1 and 9, representing the position on the map. If it is free, the player's symbol will be placed in that cell.
